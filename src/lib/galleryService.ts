...
function docToSavedCard(data: Record<string, unknown>): SavedCard {
  ...
  return {
    ...
    mainTextBoxLineHeight: (data.mainTextBoxLineHeight ?? 0) as number,
    mainTextBoxLetterSpacing: (data.mainTextBoxLetterSpacing ?? 0) as number,
    attackEffectGap: (data.attackEffectGap ?? (data.attackEffectSpaced ? 1 : 0)) as number,
