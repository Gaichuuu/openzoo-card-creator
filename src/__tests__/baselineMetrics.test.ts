...
import { computeDelta, referenceBox, primaryFamily } from '@/lib/baselineMetrics';
...
describe('computeDelta', () => {
  ...
  it('ignores sub-hundredth noise rather than writing a pointless offset', () => {
    expect(computeDelta({ ascent: 7.001, descent: 2 }, { ascent: 7, descent: 2 })).toBe(0);
  });
